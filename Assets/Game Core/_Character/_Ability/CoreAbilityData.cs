...
public sealed class CoreAbilityData {
    ...
    public CharStatsValContainer CoreStatsValues { get; private set; }
    ...
    public CoreAbilityData(Character character, AbilityProperties abilityProperties, CharStatsValContainer coreStatsValuesContainer, Combat combat,
    ...
    public CoreAbilityData(Character character, AbilityProperties abilityProperties, AbilityPropertiesValuesContainer abilityPropertiesValuesContainer,
        CharStatsValContainer coreStatsValuesContainer, Combat combat, AbilityObject abilityObject, SkillTemplate skillLogic, Vector3 castPoint, GameObject target) {
        CharacterComponent = character;
        CharacterHitLayers = character;
        AbilityProperties = abilityProperties;
